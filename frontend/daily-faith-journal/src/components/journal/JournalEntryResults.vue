...
<template>
    ...
    <section>
      <div class="entries">
          ...
          <ul>
            <li v-for="entry in filteredEntries" :key="entry.id">
              ...
              <default-card class="m-4">
                ...
                <div class="actions">
                  <default-button link :to="'/journalentries/view/'+ entry.id" text="View" buttonType="primary" class="m-2" />
        ...
        <!--if an error has occurred: server or other error-->
        <div v-if="errorOccurred != null">
