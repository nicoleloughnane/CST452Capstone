...
const router = createRouter({
    ...
    routes: [
        ...
        {path: '/journalentries/:userSearchQuery', component: JournalEntryResults, name: 'JournalEntryResults', meta: {requiresAuth: true}},
        {path: '/journalentries/create', component: CreateJournalEntry, meta: {requiresAuth: true}},
        {path: '/journalentries/view/:_id', component: ViewJournalEntry, meta: {requiresAuth: true}},
        {path: '/journalentries/edit/:_id', component: EditJournalEntry, meta: {requiresAuth: true}},
        {path: '/journalentries/delete/:_id', component: DeleteJournalEntry, meta: {requiresAuth: true}},
        //sermon notes
        {path: '/sermonnotes', component: SermonNoteHome, meta: {requiresAuth: true}},
        {path: '/sermonnotes/:userSearchQuery', component: SermonNoteResults, name: 'SermonNoteResults', meta: {requiresAuth: true}},
        {path: '/sermonnotes/create', component: CreateSermonNote, meta: {requiresAuth: true}},
        {path: '/sermonnotes/view/:id', component: ViewSermonNote, meta: {requiresAuth: true}},
        {path: '/sermonnotes/edit/:id', component: EditSermonNote, meta: {requiresAuth: true}},
        {path: '/sermonnotes/delete/:id', component: DeleteSermonNote, meta: {requiresAuth: true}},
